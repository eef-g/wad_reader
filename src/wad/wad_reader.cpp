...
LINEDEF WADReader::ReadLinedef(int offset) {
  // TODO: Figure out why this breaks at the specific offset
  // Breaks at offset = 75532
  LINEDEF output;
...
SIDEDEF WADReader::ReadSidedef(int offset) {
  ...
  // Convert the upper_texture, lower_texture, and middle_texture to a usable 8
  // character array of chars
  for (int i = 0; i < 8; i++) {
